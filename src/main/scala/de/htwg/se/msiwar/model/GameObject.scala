...
case class PlayerObject(override val name: String, override val imagePath: String, override val position: Position, playerNumber: Int, var actionPoints: Int, var healthPoints: Int, actions: List[Action]) extends GameObject(name, imagePath, position) {
