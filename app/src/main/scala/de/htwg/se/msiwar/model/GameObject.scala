...
case class PlayerObject(override val name: String, override val imagePath: String, override val position: Position, playerNumber: Int, wonImagePath: String, private val maxActionPoints: Int, private var maxHealthPoints: Int, actions: List[Action]) extends GameObject(name, imagePath, position) {
